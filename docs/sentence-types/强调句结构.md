...
Sources: [Original Article](https://www.kekenet.com/grammar/1303.htm)
...
典型例题  
1） It was last night \_\_\_ I see the comet.  
...
2）It is ten years \_\_\_ Miss Green returned to Canada.  
A. that　B. when　 C. since　 D. as　 答案C. 考点是连词用法。 本题易误选为A. that. 其实本句不是强调句。若是，去掉It　 be… that还应是一个完整的句子。而本句去掉 'It is…that'，只剩下ten years Miss Green returned to Canada. 不成句。因此本句不是强调句。  
